...
class AgentState(MessagesState):
    ...
    # options overlay step
    options_strategy_report: Annotated[
        str, "Report from the Options Strategist, including any risk-gate veto"
    ]
    options_trade_plan: Annotated[
        Optional[Dict[str, Any]],
        "Gate-approved options trade plan, or None when no options trade is taken",
    ]
